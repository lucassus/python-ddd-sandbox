...
def user_register_endpoint(
    ...
    # register_user: Annotated[RegisterUser, Depends(Provide[Container.register_user])],
...
def user_update_endpoint(
    ...
    # change_user_email_address: Annotated[ChangeUserEmailAddress, Depends(Provide[Container.change_user_email_address])],
